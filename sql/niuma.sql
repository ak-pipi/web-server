...
CREATE TABLE `district` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='区域表，区域内包含任意多个场地，例如逮狗腿游戏中的新手房';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `district` VALUES (1,'逮狗腿新手房',1500,2),(2,'逮狗腿初级房',3000,2),(3,'逮狗腿高级房',7500,0),(4,'逮狗腿大师房',15000,0),(5,'掼蛋初级房',0,2),(6,'掼蛋中级房',0,2),(7,'掼蛋高级房',0,2),(8,'掼蛋大师房',0,2),(9,'桃江麻将 底注1 4局',0,0),(10,'桃江麻将 底注1 8局',0,0),(11,'桃江麻将 底注2 8局',0,0),(12,'桃江麻将 底注2 16局',0,0),(13,'桃江麻将 底注5 8局',0,0),(14,'桃江麻将 底注5 16局',0,0),(15,'桃江麻将 底注10 8局',0,0),(16,'桃江麻将 底注10 16局',0,0),(17,'红中麻将 底注1 8局',0,0),(18,'红中麻将 底注2 8局',0,0),(19,'红中麻将 底注5 8局',0,0),(20,'红中麻将 底注10 8局',0,0),(21,'长沙麻将 底注1 8局',0,0),(22,'长沙麻将 底注2 8局',0,0),(23,'长沙麻将 底注5 8局',0,0),(24,'长沙麻将 底注10 8局',0,0),(25,'跑得快 底注1 8局',0,0),(26,'跑得快 底注2 8局',0,0),(27,'跑得快 底注5 8局',0,0),(28,'跑得快 底注10 8局',0,0),(29,'歪胡子 底注1 8局',0,0),(30,'歪胡子 底注2 8局',0,0),(31,'歪胡子 底注5 8局',0,0),(32,'歪胡子 底注10 8局',0,0),(33,'沅江千分 底注1 8局',0,0),(34,'沅江千分 底注2 8局',0,0),(35,'沅江千分 底注5 8局',0,0),(36,'沅江千分 底注10 8局',0,0);
