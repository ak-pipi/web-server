...
CREATE TABLE `capital` (
  ...
  `gold` decimal(18,1) NOT NULL DEFAULT '0.0' COMMENT '金币数量，支持一位小数积分',
  `deposit` decimal(18,1) NOT NULL DEFAULT '0.0' COMMENT '银行金币存款，支持一位小数积分',
...
CREATE TABLE `cash_pledge` (
  ...
  `amount` decimal(18,1) NOT NULL COMMENT '押金数额，支持一位小数积分',
...
INSERT INTO `district` VALUES (9,'单局桃麻5',0,0),(10,'单局桃麻10',0,0),(11,'单局桃麻25',0,0),(12,'桃麻必中1',0,0),(13,'桃麻必中2',0,0),(14,'桃麻必中5',0,0),(15,'桃麻必中10',0,0),(16,'桃麻必中20',0,0),(17,'8局红中1',0,0),(18,'8局红中2',0,0),(19,'8局红中5',0,0),(20,'8局红中10',0,0),(21,'台桌1 · 8局',0,0),(22,'台桌2 · 8局',0,0),(23,'台桌5 · 8局',0,0),(24,'台桌10 · 8局',0,0),(25,'3毛跑得快',30,0),(26,'5毛跑得快',50,0),(27,'1块跑的快',100,0),(28,'1块跑扎鸟',200,0),(29,'底注1 · 8局',0,0),(30,'底注2 · 8局',0,0),(31,'底注5 · 8局',0,0),(32,'底注10 · 8局',0,0),(33,'底注1 · 8局',0,0),(34,'底注2 · 8局',0,0),(35,'底注5 · 8局',0,0),(36,'底注10 · 8局',0,0),(37,'斗地主 底注1 · 8局',0,0),(38,'斗地主 底注2 · 8局',0,0),(39,'斗地主 底注5 · 8局',0,0),(40,'斗地主 底注10 · 8局',0,0),(41,'单局红中5',0,0),(42,'单局红中10',0,0),(43,'单局红中1',0,0),(44,'8局红中20',0,0),(45,'台桌5 · 单局',0,0),(46,'台桌10 · 单局',0,0),(47,'台桌25 · 单局',0,0),(48,'台桌20 · 8局',0,0),(49,'单局5块跑',300,0),(50,'单局10块跑',600,0),(51,'单局10块跑',600,0),(52,'2块跑扎鸟',400,0);
